...
- Wiki 页 Related 标签跳转已使用真实知识库 `D:\MyWiki-MVP\工作-wiki-2026` 回归：从“内蒙古福瑞医疗科技股份有限公司”通过 `concepts/数字生命研发专项计划` 跳到目标 Wiki 后等待刷新仍停留在目标页；新增单元测试覆盖从 `?ref=` 打开 A、点击 related 到 B、再触发数据刷新时不得回跳 A。
